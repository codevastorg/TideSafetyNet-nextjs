...
const ForgotPassword = () => {
  return (
    <>
      ...
      {/* Content */}
      <div className="bg-soft-success" style={{
      display: 'flex',
          ...
          <div className="mx-auto" style={{ maxWidth: '30rem' }}>
            ...
            <div className="card card-lg zi-2">
              ...
              <div className="card-header text-center">
                ...
                <p className="card-text">Enter the email address you used when you joined and well send you instructions to reset your password.</p>
              </div>
              {/* End Header */}
              ...
              <div className="card-body">
                <form className="js-validate need-validate" noValidate>
                  {/* Form */}
                  <div className="mb-4">
                    <label className="form-label" htmlFor="forgotPasswordFormEmail">Your email</label>
                    <input type="email" className="form-control" name="forgotPasswordEmailName" id="forgotPasswordFormEmail" placeholder="Enter your emaill address" aria-label="Enter your emaill address" required />
                  ...
                  <div className="text-center">
                    <a className="btn btn-link" href="../page-login.html">
